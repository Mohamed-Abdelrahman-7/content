...
| page_size | The maximum number of results to return per page. If the value is negative or exceeds 1000, the request is rejected. Default is 50. | Optional | 
...
```!gcp-logging-log-entries-list project_id=platform-content-01 limit=1```
...
>|---|---|---|---|---|
>| 2025-07-08T12:53:02.656668408Z | projects/platform-content-01/logs/cloudaudit.googleapis.com%2Factivity | 1jst2v7e28zrn | type: audited_resource<br>labels: {"service": "cloudresourcemanager.googleapis.com", "method": "google.cloud.resourcemanager.v3.Projects.SetIamPolicy", "project_id": "platform-content-01"} | NOTICE |
